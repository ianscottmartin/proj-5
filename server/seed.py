...
with app.app_context():
    ...
    def add_reviews(num_reviews=50):
        for _ in range(num_reviews):
            user_id = faker.random_int(min=1, max=20)  # Replace with the actual range of user IDs
            artist_id = faker.random_int(min=1, max=5)  # Replace with the actual range of artist IDs
            museum_id = faker.random_int(min=1, max=6)  # Replace with the actual range of museum IDs
